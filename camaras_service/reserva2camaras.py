...
class AplicacionDetector:
    def __init__(self, root):
        ...
        self.cuadro_camara_1.grid(row=0, column=0, columnspan=3)
        
        self.cuadro_camara_2 = tk.Label(self.root)
        self.cuadro_camara_2.grid(row=0, column=3, columnspan=3)
        ...
        # Hilos para mostrar las cámaras
        self.hilo_camara_1 = Thread(target=self.mostrar_camara, args=(0, self.cuadro_camara_1), daemon=True)
        self.hilo_camara_2 = Thread(target=self.mostrar_camara, args=(1, self.cuadro_camara_2), daemon=True)
        self.hilo_camara_1.start()
        self.hilo_camara_2.start()
    ...
    def mostrar_camara(self, camara_id, cuadro):
        """Muestra la cámara y aplica detección para la cámara especificada."""
        ...
        while self.ejecutando:
            ...
            cuadro.imgtk = tk.PhotoImage(data=photo)
            cuadro.configure(image=cuadro.imgtk)
    ...
    def detener(self):
        ...
        self.hilo_camara_1.join()
        self.hilo_camara_2.join()
        self.root.destroy()
